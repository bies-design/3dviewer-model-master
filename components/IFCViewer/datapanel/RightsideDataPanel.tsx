    ...
    <div className="absolute right-4 top-25 bottom-10 w-[20%] h-[85%] z-10 flex flex-col gap-4 pointer-events-none">
      ...
      <div className="relative hud-panel h-[12%] flex gap-2 items-center justify-center">
        <div className="flex flex-col items-center px-4 border-r border-white/10">
          <span className="text-xl uppercase tracking-[0.7em]"><span className="text-orange-400 font-semibold">本月</span>用電</span>
          <span className="text-xl font-bold text-[#84ebf8]">11,121 <small className="text-8 font-normal">kWh</small></span>
        </div>
        <div className="flex flex-col items-center px-4">
          <span className="text-xl uppercase tracking-[0.7em]"><span className="text-orange-400 font-semibold">本年</span>用電</span>
          <span className="text-xl font-bold text-[#84ebf8]">111,121 <small className="text-8 font-normal">kWh</small></span>
        </div>
      </div>
      {/*中段：需量監控 */}
      <Card className={`rounded-none hud-panel h-[16%] p-4 relative pointer-events-auto ${darkMode ? 'bg-transparent' : 'bg-white/40'}`}>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col">
            <span className="text-10">即時需量</span>
            <span className="text-lg font-bold text-[#84ebf8]">430.157 <small className="text-8 font-normal">kW</small></span>
          </div>
          <div className="flex flex-col">
            <span className="text-10">本月最大需量</span>
            <span className="text-lg font-bold text-[#84ebf8]">436.562 <small className="text-8 font-normal">kW</small></span>
          </div>
        </div>
      </Card>
      ...
      <Card className={`rounded-none hud-panel h-[52%] p-4 pointer-events-auto relative overflow-hidden ${darkMode ? 'bg-transparent' : 'bg-white/60'}`}>
        ...
        <Tabs
          ...
          classNames={{
            ...
            tabContent: "group-data-[selected=true]:text-[#84ebf8] text-[18px] font-semibold"
          }}
        >
          <Tab
            key="annual"
          ...
          <Tab
            ...
            title={
              <div className="flex items-center gap-2">
                <span className="w-1 h-3 bg-cyan-500 rounded-full"></span>
                <span className="text-xl">近30日用電量趨勢圖</span>
              </div>
            }
          >
